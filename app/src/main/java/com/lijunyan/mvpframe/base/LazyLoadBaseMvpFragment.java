 ...
 * 懒加载 mvp fragment
 */
public abstract class LazyLoadBaseMvpFragment extends BaseMvpFragment{
    ...
    private boolean isParentInvisible() {
        ...
        if (parentFragment instanceof LazyLoadBaseMvpFragment) {
            LazyLoadBaseMvpFragment fragment = (LazyLoadBaseMvpFragment) parentFragment;
    ...
    private void dispatchChildVisibleState(boolean visible) {
        ...
        if (!fragments.isEmpty()) {
            for (Fragment child : fragments) {
                if (child instanceof LazyLoadBaseMvpFragment && child.isAdded() && !child.isHidden() && child.getUserVisibleHint()) {
                    ((LazyLoadBaseMvpFragment) child).dispatchUserVisibleHint(visible);
                }
            }
        }
    }
